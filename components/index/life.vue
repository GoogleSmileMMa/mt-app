    ...
    <el-row>
      ...
      <el-col :span="6">
        <div class="m-life-login">
          <h4>
            <img 
              src="//s0.meituan.net/bs/fe-web-meituan/2d052b/img/avatar.jpg" 
              alt="">
          </h4>
          <p class="m-life-login-name">Hi 你好</p>
          <p>
            <nuxt-link to="/register">
              <el-button size="medium">round</el-button>
            </nuxt-link>
            <nuxt-link to="/login">
              <el-button size="medium">立即登陆</el-button>
            </nuxt-link>
          </p>
        </div>
      </el-col>
...
<style lang="scss">
	@import "../../assest/css/index/life.scss"
</style>